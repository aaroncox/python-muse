...
from musebase.operationids import operations, getOperationNameForId
...
class Blockchain(object):
    ...
    def info(self):
        ...
        """
        return self.muse.rpc.get_dynamic_global_properties()
    ...
    def get_network(self):
        """ Identify the network
            ...
            :rtype: dict
        """
        return self.muse.rpc.get_network()

    def get_chain_properties(self):
        """ Return chain properties
        """
        return self.muse.rpc.get_chain_properties()

    def config(self):
        """ Returns object 2.0.0
        """
        return self.muse.rpc.get_object("2.0.0")
    ...
    def blocks(self, start=None, stop=None):
        ...
        while True:
            ...
            for blocknum in range(start, head_block + 1):
                # Get full block
                block = self.muse.rpc.get_block(blocknum)
    ...
    def awaitTxConfirmation(self, transaction, limit=50):
        """ Returns the transaction as seen by the blockchain after being included into a block
            ...
            .. note:: If you want instant confirmation, you need to instantiate
                      class:`muse.blockchain.Blockchain` with
    ...
    def get_all_accounts(self, start='', stop='', steps=1e3, **kwargs):
        ...
        lastname = start
        while True:
            ret = self.muse.rpc.lookup_accounts(lastname, steps)
            for account in ret:
                yield account[0]
                if account[0] == stop:
                    raise StopIteration
