...
class Amount(dict):
    """ This class deals with Amounts of any asset to simplify dealing with the tuple::
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a list of a ``float`` and a :class:`muse.asset.Asset`
        ...
        An instance is a dictionary and comes with the following keys:
            ...
            * ``amount`` (float)
            * ``symbol`` (str)
            * ``asset`` (instance of :class:`muse.asset.Asset`)
    ...
    @property
    def asset(self):
        """ Returns the asset as instance of :class:`muse.asset.Asset`
        """
        if not self["asset"]:
            self["asset"] = Asset(self["symbol"], muse_instance=self.muse)
        return self["asset"]
