...
from musebase.chains import known_chains
from . import exceptions
import logging
log = logging.getLogger(__name__)


class MuseNodeRPC(GrapheneWebsocketRPC):

    def __init__(self, *args, **kwargs):
        super(MuseNodeRPC, self).__init__(*args, **kwargs)
    ...
    def rpcexec(self, payload):
        """ Execute a call by sending the payload.
            ...
            In here, we mostly deal with muse specific error handling
        ...
        try:
            ...
            return super(MuseNodeRPC, self).rpcexec(payload)
