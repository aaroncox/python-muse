...
class Address(GPHAddress):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``MUSE``)

        Example::

           Address("MUSEFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")

    """
    def __init__(self, *args, **kwargs):
        if "prefix" not in kwargs:
            kwargs["prefix"] = "MUSE"  # make prefix MUSE
...
class PublicKey(GPHPublicKey):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("MUSE6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
