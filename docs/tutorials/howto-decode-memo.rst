...
In muse, memos are usually encrypted using a distinct memo key. That way,
...
That private key can be added to the pymuse wallet with:
...
.. code-block:: python
    ...
    MUSE.wallet.create("wallet-decrypt-password")
    MUSE.wallet.unlock("wallet-decrypt-password")
    MUSE.wallet.addPrivateKey("5xxxxxxxxxxx")
...
.. code-block:: python
    ...
    memo.muse.wallet.unlock("wallet-decrypt-password")
